...
public class LegacyTrackingEndpoint {
    private static final Logger logger = LoggerFactory.getLogger(LegacyTrackingEndpoint.class);

    private final ViewsService visitaService;

    @Inject
    public LegacyTrackingEndpoint(ViewsService visitaService) {
