...
class DashboardTest {
    ...
    void dashboardShouldDisplayCorrectData(WebDriver driver, ViewSession session) {
        ...
        Assertions.assertThat(dailyVisitsTable.findElements(By.tagName("th")))
                  ...
                  .containsExactly("data", "visitas", "tempo médio (s)");
        ...
        Assertions.assertThat(visitsByPageTable.findElements(By.tagName("th")))
                  ...
                  .extracting(WebElement::getText)
                  .extracting(String::toLowerCase)
                  .containsExactly("página", "visitas", "tempo médio (s)");
    ...
    void dashboardShouldHandleEmptyData(WebDriver driver) {
        ...
        // Depending on template implementation, it might have 0 rows or rows with placeholder data
    ...
    void dashboardShouldUpdateOnNewVisits(WebDriver driver, ViewSession session) throws InterruptedException {
        ...
        // In a real scenario, you might need to refresh the page or it might auto-update
